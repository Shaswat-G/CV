...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Master's Thesis Researcher: Adaptive multi-objective query routing in heterogeneous engines}{Zurich, Switzerland}
      \resumeItemListStart
        \resumeItem{Training GNN-based cost model for multi-objective query optimization across distributed heterogeneous database systems}
      \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
          {Industry Internships}{2019 -- 2021}
