...
\begin{itemize}[leftmargin=0.15in, itemsep=-2pt]  
  ...
  \item \textbf{Machine Learning:} PyTorch, TensorFlow, scikit-learn, XGBoost, Hugging Face Transformers, Computer Vision, NLP, Experiment Design, A/B Testing, Statistical Inference
  \item \textbf{MLOps \& Cloud:} Git, Docker, Kubernetes, GitHub Actions, MLflow, Model Monitoring, AWS (EC2/S3/Lambda), Azure ML, GCP
  \item \textbf{Data Engineering:} Pandas, Numpy, Apache Airflow, Apache Kafka, Scipy, Snowflake, PostgreSQL, MongoDB, vector databases
  \item \textbf{Performance Engineering:} Performance Profiling, Resource Instrumentation, Distributed Training (Spark, Ray), HPC Optimization, Model Parallelization
\end{itemize}
}
