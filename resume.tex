...
\resumeSubHeadingListStart
      ...
      {Master's Thesis (Research): Adaptive multi-objective query routing in heterogeneous engines}{Zurich, Switzerland}
            \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Research: Machine Learning Research Projects \& AI Engineering}{Zurich, Switzerland}
            \resumeItemListStart
